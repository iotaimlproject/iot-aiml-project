...
from ml_model.train.config import FEATURE_NAMES, M1_CONFIG, TRAIN_CSV, MODELS_DIR, TARGET_M1, M1_SEEDS
...
def train(csv_path=None, split_ratio=0.8):
    ...
    logger.info(f"Saved ensemble models + scaler_m1.pkl to {MODELS_DIR}")
    return ensemble_preds, y_pred, y_test, scaler
